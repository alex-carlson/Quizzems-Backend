...
import { uploadUserAvatar, getUserProfile, createUserProfile, changeUsername, getUsernames, completeQuiz } from '../controllers/userController.js';
...
router.post('/updateUsername', verifySupabaseToken, changeUsername);
